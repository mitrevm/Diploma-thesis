...
#SBATCH --array=0-80         # 10 trains * 10 tests = 100 jobs
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Use exact 1..50 by 5
#TRAINS=(1 5 10 15 20 25 30 35 40)
#TESTS=(1 5 10 15 20 25 30 35 40)
TRAINS=(1 5 10 15 20 25 30 35 40)
TESTS=(1 5 10 15 20 25 30 35 40)
MODEL="prot_albert"
...
python3 /d/hpc/home/mm5129/final_pipeline_cpu_mean_first_embeddings_test_regularization.py \
    --train "$TRAIN" \
    --test "$TEST" \
    --model "$MODEL" \
    --random_seed 30 \
