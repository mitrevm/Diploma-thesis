...
def create_data_set(selected_df: pd.DataFrame,
    ...
    def process_df(input_df, is_training=False, model= ""):
        ...
        for _, row in input_df.iterrows():
            ...
            # capri_ss_path = (f"/d/hpc/home/mm5129/Diplomska/TrgB1_cropped_TrgC1_cel/collected_caprieval/07_caprieval_run_new_model_0_"
            #                  f"{row['trgb1_gen']}_{row['trgc1_gen']}/capri_ss.tsv")
            try:
    ...
    for n_in_training in [n_in_training]:
        for n_in_test in [n_in_test]:
            ...
            if "percent" not in results_df.columns:
                ...
                continue
            folder = f"/d/hpc/home/mm5129/A_pairs_fixed/Hybrid/svm/model_{model}/test_embeddings_data/csv"
