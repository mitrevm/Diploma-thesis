    ...
    def process_df(input_df, is_training=False, model=""):
        ...
        for _, row in input_df.iterrows():
            ...
            try:
                ...
                df_row = df_full[required_columns].mean().to_frame().T
        ...
        if all_data:
            ...
            columns = [['compatible'] + embeded_cols]
...
def parse_args():
    ...
    parser.add_argument("--pca", type=int, default=3, help="PCA")
   ...
   # model = "esm2_t12_35M_UR50D"
    ...
    for n_in_training in [n_in_training]:
        for n_in_test in [n_in_test]:
            ...
            folder = f"/d/hpc/home/mm5129/A_pairs_fixed/OnlyEmbeddings/pca/model_{model}/{pca}/csv"
