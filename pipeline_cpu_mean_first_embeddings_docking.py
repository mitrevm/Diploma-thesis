...
# ---------------------- Helper Functions ----------------------
def find_related_rows(df, n=15, random_seed=42):
    results = []
...
def create_data_set(selected_df: pd.DataFrame,
    ...
    def process_df(input_df, is_training=False, model=""):
        ...
        for _, row in input_df.iterrows():
           #Diplomska/TrgB1_cel_TrgC1_cropped
            capri_ss_path = (
                f"/d/hpc/home/mm5129/Diplomska/domains_only/collected_caprieval/"
...
if __name__ == "__main__":
    ...
    df = pd.read_csv("pairs_with_scores_add_extra.csv")
    pca = args.pca
    ...
    for n_in_training in [n_in_training]:
        for n_in_test in [n_in_test]:
            ...
            folder = f"/d/hpc/home/mm5129/A_pairs_fixed/Final_docking/domains_only/csv"
