            ...
            try:
                ...
                try:
                    if "nc" in row["trgc1_gen"]:
                        ...
                        emb = load_embedding(f"TRGC_{row['trgc1_gen']}", model)
                    else:
...
def parse_args():
    ...
    parser.add_argument("--pca", type=int, default=2, help="PCA dimension")
...
if __name__ == "__main__":
    ...
    for n_in_training in [n_in_training]:
        for n_in_test in [n_in_test]:
            ...
            folder = f"/d/hpc/home/mm5129/A_pairs_fixed/Hybrid/model_{model}/pca={pca}/csv"
